/**
 * @generated-file-note
 * 文件：smart-tools-backend/smart-tools-domain/src/main/java/com/example/smarttools/domain/tool/SysTool.java
 ...
 * 公开方法：prePersist()；preUpdate()；getId()；getSlug()；setSlug(String slug)；getName()；setName(String name)；getCategory()；setCategory(String category)；getDescription()；setDescription(String description)；getKeywords()；setKeywords(String keywords)；isEnabled()；setEnabled(boolean enabled)；getSortOrder()
