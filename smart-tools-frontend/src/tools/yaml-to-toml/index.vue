<!--
  @generated-file-note
  文件：smart-tools-frontend/src/tools/yaml-to-toml/index.vue
  ...
  <div class="max-w-4xl mx-auto space-y-6">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 h-[600px]">
      <div class="flex flex-col">
        ...
        <el-input v-model="yaml" type="textarea" class="flex-1" :rows="20" @input="convert" />
      </div>
      <div class="flex flex-col">
