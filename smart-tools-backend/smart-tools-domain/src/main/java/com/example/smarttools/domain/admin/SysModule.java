/**
 * @generated-file-note
 * 文件：smart-tools-backend/smart-tools-domain/src/main/java/com/example/smarttools/domain/admin/SysModule.java
 ...
 * 公开方法：prePersist()；preUpdate()；getId()；getCode()；setCode(String code)；getName()；setName(String name)；getDescription()；setDescription(String description)；getSortOrder()；setSortOrder(int sortOrder)；isEnabled()；setEnabled(boolean enabled)；getCreatedAt()；getUpdatedAt()
